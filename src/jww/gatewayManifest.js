...
export const GATEWAY_OPEN_ITEMS = [
  {
    ...
    conversionImpact:
      "bounded v600/v700 and generated-fixture Jw_cad 6.20 Save As/reload evidence is established, including one intentional LINE edit; independently authored v600 ARC/CIRCLE/LINE parser evidence is established, while DIMENSION/BLOCK/IMAGE remain unverified",
    releaseDecision:
      "claim only the recorded Jw_cad 10.02.1, bounded v600/v700, and generated-fixture Jw_cad 6.20 Save As/reload and intentional LINE-edit results including the recorded normalizations; do not claim version-wide or independently authored v600 compatibility",
    title: "JWW version and entity conformance corpus",
    detail:
      "Fifteen Jw_cad-installed v600 samples totaling 22,624 drawing entities parse cleanly and survive Gateway template rewrites with drawing and document semantic equality. A public GitHub mirror in KEINOS/Jw_cad-for-Mac contains byte-identical copies of all fifteen files; a separate Gateway scan again reports internal version 600 with zero unsupported or skipped records. This makes the installed-sample baseline publicly reproducible, but the mirrored files remain the same standard sample set. Two independently authored Matrix vehicle drawings published in 2008 and 2009 were retrieved from the public distributor with archive MD5 values matching the published checksums. Gateway identifies both as internal version 600 and parses their combined 2,267 ARC/CIRCLE/LINE records with zero unsupported or skipped records. Jw_cad 10.02.1 opened, edited, saved, and reopened the representative standard-sample Gateway output. An actual Jw_cad 6.20 runtime in a dedicated VM opened, separately saved, and reopened generated v600 DIMENSION, BLOCK/INSERT, and external IMAGE-reference fixtures; every output was non-empty and parser-clean, while Jw_cad 6.20 applied the recorded DIMENSION text-endpoint/settings, BLOCK definition-number, and IMAGE pen-color/text-endpoint normalizations. A separate generated DIMENSION-fixture cycle added one LINE, saved a 16,460-byte parser-clean v600 file, isolated the intended LINE from Jw_cad 6.20 normalization, and reloaded visibly. Independently authored v600 DIMENSION, BLOCK/INSERT, and IMAGE records remain unavailable.",
    evidence:
      "JWW_VERSION_CONFORMANCE_EVIDENCE.md separates installed-sample, byte-identical public-mirror, and independently authored Matrix parser evidence; generated entity-family coverage; Jw_cad 10.02.1 GUI evidence; Jw_cad 6.20 generated-fixture Save As/reload and intentional LINE-edit evidence; automatic normalizations; and the remaining independently authored entity-family boundary.",
    nextAction:
      "Obtain non-private independently authored v600 DIMENSION, BLOCK/INSERT, and IMAGE samples, then record parser, visual, Save As, semantic-diff, and Jw_cad 6.20 reload evidence without treating the generated intentional LINE edit or mirrored standard samples as independent-author evidence.",
  },
];
