...
export const GATEWAY_OPEN_ITEMS = [
  {
    ...
    conversionImpact:
      "bounded v600/v700 and generated-fixture Jw_cad 6.20 Save As/reload evidence is established, including one intentional LINE edit; independently authored v600 ARC/CIRCLE/LINE/SOLID/TEXT parser evidence is established, while DIMENSION/BLOCK/IMAGE remain unverified",
    releaseDecision:
